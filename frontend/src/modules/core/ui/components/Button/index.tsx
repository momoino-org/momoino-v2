...
type ButtonProps = VariantProps<typeof button> & ComponentPropsWithRef<'button'> & {
  asChild?: boolean;
};

export const Button = ({ asChild, ...rest }: ButtonProps): ReactNode => {
  const Component = asChild ? Slot : "button";

  return <Component type="button" className={button(rest)} {...rest} />;
}
